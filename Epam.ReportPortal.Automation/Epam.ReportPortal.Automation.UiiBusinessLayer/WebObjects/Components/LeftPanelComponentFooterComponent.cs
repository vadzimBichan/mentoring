...
public class LeftPanelComponent : BaseWebComponent
{
    ...
    public IWebElement FiltersItem => Driver.FindElement(By.XPath("//div[contains(@class,'sidebarButton__sidebar-nav-btn') and .//span[text()='Filters']]"));

    public IWebElement ProjectSettingsItem => Driver.FindElement(By.XPath("//div[contains(@class,'sidebarButton__sidebar-nav-btn') and .//span[text()='Project settings']]"));
}